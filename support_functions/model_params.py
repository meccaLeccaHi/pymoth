def specifyModelParamsMnist( nF=85, goal=20 ):
    # [modelParams] = specifyModelParamsMnist( nF, goal ) generates the param structure
    #   for the moth, ie the template that is used to populate connection matrices
    ...
    hebTauKE = 0.02*goal # controls learning rate for K2E weights. 1/decay rate.
    ...
    slopeParam = desiredSlope*4/C # a convenience variable.
